...
@dag(
        ...
        start_date=datetime(year=2026,month=6, day=2,tz="Asia/Kolkata"),
        # schedule=CronTriggerTimetable("0 10 * * MON-FRI",timezone="Asia/Kolkata"),
        end_date=datetime(year=2026,month=6, day=30,tz="Asia/Kolkata"),
...
#instantiate the DAG
schedule_cron_dag = schedule_cron_dag()